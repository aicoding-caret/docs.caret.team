...
Focus Chain ist eine Funktionserweiterung für das Task Management in Caret, die eine automatische Todo-Listen-Verwaltung mit Echtzeit-Fortschrittskontrolle während Ihrer Aufgaben bietet. 
...
Dies ermöglicht es Caret, an langfristigen Aufgaben zu arbeiten, den an LLMs gesendeten Kontext nahtlos zu verwalten und Caret über viele Context Window Resets hinweg auf Kurs zu halten.
...
Caret analysiert Ihre Aufgabe und erstellt automatisch eine umfassende Todo-Liste mit:
...
- Nahtlose Integration zurück in den Workflow von Caret
...
<Steps>
  <Step title="Caret-Einstellungen öffnen">
      - Klicken Sie auf das Zahnrad-Symbol in der Caret-Seitenleiste
      - Navigieren Sie zum Bereich „Features“
  </Step>
  <Step title="Focus Chain aktivieren">
      - Aktivieren Sie „Enable Focus Chain“
      - Passen Sie optional das „Remind Caret Interval“ an (Standard: 6 Nachrichten)
  </Step>
  <Step title="Eine neue Aufgabe starten">
      - Beginnen Sie eine neue Aufgabe
      - Caret beginnt automatisch mit der Erstellung und Verwaltung von Todo-Listen
  </Step>
</Steps>
...
| Remind Caret Interval | 6 | 1-100 Nachrichten | Wie oft Caret die Todo-Liste aktualisiert |
...
Caret erstellt einen umfassenden Plan für die Aufgabe, der in einer Markdown-Datei gespeichert wird:
...
Während Caret arbeitet, zeigt der Task-Header den Echtzeit-Fortschritt:
...
<Steps>
  ...
  <Step title="Datei speichern">
    Caret erkennt und verwendet Ihre Aktualisierungen automatisch
  </Step>
</Steps>
...
Focus Chain arbeitet nahtlos mit dem [Plan/Act-Modus](/german/features/plan-and-act) von Caret zusammen:
...
:::info
  :::details Accordion
    ...
    2. **Generierte Listen überprüfen**
      - Prüfen Sie, ob die Aufteilung von Caret Ihren Erwartungen entspricht
  ...
  :::details Accordion
    ...
    3. **Regelmäßige Überprüfungen**
      ...
      - Kommunizieren Sie Änderungen an Caret durch Bearbeitungen
  :::
  :::details Accordion
...
Immer noch festgefahren? Verwenden Sie den [/reportbug](/german/features/slash-commands/report-bug) Befehl in Caret, um Hilfe zu erhalten.
...
Focus Chain verwandelt Caret in Ihren persönlichen Projektmanager, der Sie auf Kurs hält und Ihre Aufgaben organisiert. Probieren Sie es bei Ihrem nächsten Projekt aus!