---
title: "Diktat"
description: "Kommunizieren Sie mit Careti mithilfe Ihrer Stimme für eine schnellere, natürlichere KI-Zusammenarbeit"
---
...
Verwenden Sie Diktat ständig im [Plan mode](/german/features/plan-and-act) für schnelle, wechselseitige Diskussionen. Anstatt sorgfältige, strukturierte Prompts einzutippen, denken Sie über ein Problem nach. Careti stellt klärende Fragen, antworten Sie sofort und iterieren Sie, bis Sie einen soliden Plan haben.
...
3. Melden Sie sich bei Ihrem Careti-Konto an, wenn Sie dazu aufgefordert werden
4. Installieren Sie FFmpeg, falls Sie dies noch nicht getan haben (Careti wird Sie dabei unterstützen)
