...
description: "Careti fasst Konversationen automatisch zusammen, um Platz freizugeben und das Arbeiten fortzusetzen, wenn die Konversation sich dem Kontextfensterlimit des Modells nähert."
---
...
1. Careti verwendet einen [Summarization Prompt](https://github.com/caret/caret/blob/main/src/core/prompts/contextManagement.ts), um eine Zusammenfassung der Konversation anzufordern.

2. Sobald die Zusammenfassung generiert wurde, ersetzt Careti den Konversationsverlauf durch einen [Continuation Prompt](https://github.com/caret/caret/blob/main/src/core/prompts/contextManagement.ts#L69), der Careti auffordert, weiterzuarbeiten, und die Zusammenfassung als Kontext bereitstellt.
