...
description: "Eine Schritt-für-Schritt-Anleitung zum Erstellen deines ersten Caret-Workflows"
---
...
<Steps>
  ...
  <Step title="Den Workflow ausführen">
    ...
    1. Öffne das Caret Chat Panel
    2. Gib `/pr-review.md` gefolgt von der PR-Nummer ein (z. B. `/pr-review.md 42`)
    3. Caret ruft PR-Details ab, analysiert den Code und zeigt Ergebnisse an

    <Tip>
      Wenn Caret Befehle wie `gh pr view` ausführt, pausiert er möglicherweise, um die Ausgabe anzuzeigen. Klicke auf **Proceed While Running**, damit Caret fortfahren kann.
    </Tip>
  </Step>
</Steps>
...
Suche nach sich wiederholenden Aufgaben in deinem Workflow und verwandle sie in effiziente Caret Workflows.
