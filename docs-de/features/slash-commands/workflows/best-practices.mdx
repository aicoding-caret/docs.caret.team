...
Speichern Sie zunächst die Datei [create-new-workflow.md](https://github.com/caretive-ai/project-careti/blob/main/prompts/workflows/create-new-workflow.md) in Ihrem Workspace (zum Beispiel unter `.agents/context/workflows/`).
