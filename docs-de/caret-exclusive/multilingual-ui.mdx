...
Programmieren Sie komfortabel in Ihrer Muttersprache. Caret bietet echte mehrsprachige Unterstützung mit vollständig übersetzter UI und Dokumentation.

## Unterstützte Sprachen

Caret unterstützt 4 Sprachen perfekt:

### 🇰🇷 Koreanisch
- **UI**: Alle Einstellungen, Menüs und Meldungen auf Koreanisch
- **Dokumentation**: docs.caret.team/ko
- **AI-Antworten**: Automatische Antworten auf Koreanisch

### 🇺🇸 Englisch
- **UI**: Standardsprache
- **Dokumentation**: docs.caret.team/en
- **AI-Antworten**: Automatische Antworten auf Englisch

### 🇯🇵 Japanisch
- **UI**: Vollständige japanische Übersetzung
- **Dokumentation**: docs.caret.team/ja
- **AI-Antworten**: Automatische Antworten auf Japanisch

### 🇨🇳 Chinesisch
- **UI**: Unterstützung für vereinfachtes Chinesisch
- **Dokumentation**: docs.caret.team/zh
...
Caret erkennt automatisch die VS Code-Spracheinstellungen:
...
Direkt in den Caret-Einstellungen auswählen:
...
- ✅ Input-Platzhalter: "How can Caret help you?"
...
- **Koreanisch**: https://docs.caret.team/ko
- **Englisch**: https://docs.caret.team/en
- **Japanisch**: https://docs.caret.team/ja
- **Chinesisch**: https://docs.caret.team/zh

### Automatische Weiterleitung

Beim Klicken auf Dokumentationslinks aus der Caret UI:
...
- [Kostenlos starten mit dem Caret Provider](/german/caret-exclusive/caret-provider)

---

**Die vollständige mehrsprachige UI gibt es exklusiv bei Caret.** Cline unterstützt nur Englisch.