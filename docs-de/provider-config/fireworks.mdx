---
title: "Fireworks AI"
description: "Erfahren Sie, wie Sie die blitzschnelle Inference-Plattform von Fireworks AI mit Caret konfigurieren und nutzen. Erleben Sie bis zu 4x schnellere Inference-Geschwindigkeiten mit optimierten Modellen und wettbewerbsfähigen Preisen."
---
...
3.  **Key erstellen:** Generieren Sie einen neuen API Key. Vergeben Sie einen beschreibenden Namen (z. B. "Caret").
...
1.  **Caret-Einstellungen öffnen:** Klicken Sie auf das Settings-Icon (⚙️) im Caret-Panel.
