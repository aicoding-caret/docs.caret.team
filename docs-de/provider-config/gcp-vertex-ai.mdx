---
title: "GCP Vertex AI"
description: "Konfigurieren Sie GCP Vertex AI mit Caret, um auf führende generative KI-Modelle wie Claude 3.5 Sonnet v2 zuzugreifen. Dieser Leitfaden deckt die Einrichtung der GCP-Umgebung, Authentifizierung und sichere Integration für Unternehmensteams ab."
---
...
-   **Die Caret Extension installieren:**
    -   Öffnen Sie VS Code
    -   Navigieren Sie zum Extensions Marketplace (Strg+Umschalt+X oder Cmd+Umschalt+X)
    -   Suchen Sie nach **Caret** und installieren Sie die Extension
...
-   **Caret-Einstellungen öffnen:**\
    Klicken Sie auf das Einstellungen-Icon (⚙️) innerhalb der Caret Extension
...
3. **VS Code neu starten:**\
   Stellen Sie sicher, dass VS Code neu gestartet wird, damit die Caret Extension die neuen Anmeldedaten erkennt
...
4. **Die Umgebungsvariable setzen:**
    ...
    - Dies weist die Google Cloud Client-Bibliotheken (und Caret) an, diesen Schlüssel zu verwenden
...
Indem Sie diese Schritte befolgen, kann Ihr Unternehmensteam GCP Vertex AI sicher in die Caret VS Code Extension integrieren, um die Leistung von **Claude 3.5 Sonnet v2** zu nutzen:
...
-   **Konfigurieren Sie Caret in VS Code:**\
    Installieren Sie Caret, geben Sie Ihre Project ID ein, wählen Sie die passende Region und das Modell
...
_Dieser Leitfaden wird aktualisiert, wenn sich GCP Vertex AI und Caret weiterentwickeln. Orientieren Sie sich für aktuelle Praktiken immer an der neuesten Dokumentation._