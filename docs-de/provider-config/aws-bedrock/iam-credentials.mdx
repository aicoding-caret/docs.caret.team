...
description: "Richten Sie AWS Bedrock mit Caret unter Verwendung von IAM Access Key- und Secret Key-Anmeldedaten ein. Ideal für Enterprise-Umgebungen mit etablierten IAM-Richtlinien."
---
...
-   **Caret:** Eine VS Code-Erweiterung, die als Coding-Assistent fungiert, indem sie AI-Modelle integriert – sie unterstützt Entwickler bei der Generierung von Code, beim Debugging und bei der Datenanalyse.
...
Durch Befolgen dieser Schritte kann Ihr Enterprise-Team AWS Bedrock sicher mit der Caret VS Code-Erweiterung integrieren, um die Entwicklung zu beschleunigen:
...
3. **Caret in VS Code konfigurieren:** Installieren und richten Sie Caret mit Ihren AWS-Anmeldedaten ein und wählen Sie ein passendes Modell.
