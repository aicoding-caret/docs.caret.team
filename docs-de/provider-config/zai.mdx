---
title: "Z AI (Zhipu AI)"
description: "Erfahren Sie, wie Sie die GLM-4.5-Modelle von Z AI mit Caret konfigurieren und nutzen. Erleben Sie fortschrittliches Hybrid Reasoning, agentische Fähigkeiten und Open-Source-Exzellenz mit regionaler Optimierung."
---
...
1.  **Caret-Einstellungen öffnen:** Klicken Sie auf das Zahnrad-Symbol (⚙️) im Caret-Panel.
...
- Funktioniert ausschließlich über Coding-Tools wie Caret
...
Um die GLM Coding-Pläne mit Caret zu nutzen:
...
3. **In Caret konfigurieren:** Öffnen Sie die Caret-Einstellungen, wählen Sie „Z AI“ als Provider und fügen Sie Ihren API Key in das Feld „Z AI API Key“ ein.

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="Caret-Einstellungen mit ausgewähltem zAI-Provider und hervorgehobenem API-Key-Feld" />
</Frame>

Die Einrichtung verbindet Ihr Abonnement direkt mit Caret und gibt Ihnen Zugriff auf die Tool-Calling-Fähigkeiten von GLM-4.5, die für Coding-Workflows optimiert sind.
