---
title: "SAP AI Core"
description: "Erfahren Sie, wie Sie LLM-Modelle aus dem Generative AI Hub in SAP AI Core mit Caret konfigurieren und verwenden."
---
...
- **Voraussetzung Service Plan:** Sie müssen den SAP AI Core `extended` Service Plan besitzen, um LLMs mit Caret zu nutzen. Andere Service Plans bieten keinen Zugriff auf den Generative AI Hub.
