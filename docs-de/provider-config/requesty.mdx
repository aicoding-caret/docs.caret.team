---
title: "Requesty"
description: "Erfahren Sie, wie Sie Requesty mit Caret nutzen, um auf über 150 Large Language Models zuzugreifen und diese zu optimieren."
---

Caret unterstützt den Zugriff auf Modelle über die [Requesty](https://www.requesty.ai/) AI-Plattform. Requesty bietet eine einfache und optimierte API für die Interaktion mit über 150 Large Language Models (LLMs).
...
Requesty bietet Zugriff auf eine breite Palette von Modellen. Caret wird automatisch die aktuellste Liste der verfügbaren Modelle abrufen. Die vollständige Liste der verfügbaren Modelle finden Sie auf der Seite [Model List](https://app.requesty.ai/router/list).
