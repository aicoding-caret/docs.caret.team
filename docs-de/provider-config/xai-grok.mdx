---
title: "xAI (Grok)"
description: "Erfahren Sie, wie Sie die Grok-Modelle von xAI mit Caret konfigurieren und verwenden, einschließlich API-Key-Einrichtung, unterstützten Modellen und Reasoning-Funktionen."
---
...
3.  **Key erstellen:** Klicken Sie hier, um einen neuen API-Key zu erstellen. Geben Sie Ihrem Key einen aussagekräftigen Namen (z. B. „Caret“).
...
Caret unterstützt die folgenden xAI Grok-Modelle:
