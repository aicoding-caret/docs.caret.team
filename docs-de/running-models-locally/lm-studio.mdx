---
title: "LM Studio"
description: "Eine Kurzanleitung zur Einrichtung von LM Studio für die lokale Ausführung von KI-Modellen mit Caret."
---

<Note>
Dies ist ein Dokument auf Basis von Caret. Es bezieht sich auf den Caret v3.38.1 Merge-Stand. Falls es Caret-spezifische Richtlinien gibt (unterstützte lokale Runtimes, Authentifizierung/Routing, Modellbeschränkungen), werden diese im Text durch ein `<Note>` gekennzeichnet.
</Note>

## LM Studio mit Caret einrichten

Führen Sie KI-Modelle lokal mit LM Studio und Caret aus.

### Voraussetzungen

-   Windows, macOS oder Linux Computer mit AVX2-Unterstützung
-   In VS Code installiertes Caret
...
#### 5. Caret konfigurieren

1. Öffnen Sie VS Code
2. Klicken Sie auf das Caret-Einstellungen-Symbol
...
Für die beste Erfahrung mit Caret verwenden Sie **Qwen3 Coder 30B A3B Instruct**. Dieses Modell bietet eine starke Coding-Performance und eine zuverlässige Tool-Nutzung.
...
Für eine optimale Performance mit lokalen Modellen aktivieren Sie Compact Prompts in den Caret-Einstellungen. Dies reduziert die Prompt-Größe um 90 %, während die Kernfunktionalität erhalten bleibt.

Navigieren Sie zu Caret Settings → Features → Use Compact Prompt und schalten Sie es ein.

### Wichtige Hinweise

-   Starten Sie LM Studio, bevor Sie es mit Caret verwenden
...
1. Wenn Caret keine Verbindung zu LM Studio herstellen kann:
