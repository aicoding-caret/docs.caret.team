...
Die Nutzung von MCP-Servern erhöht Ihren Token-Verbrauch. Caret bietet die Möglichkeit, die MCP-Server-Funktionalität nach Bedarf einzuschränken oder zu deaktivieren.

1. Klicken Sie auf das „MCP Servers“-Icon in der oberen Navigationsleiste der Caret-Extension.
...
3. Caret öffnet ein neues Einstellungsfenster. Suchen Sie nach `Caret>Mcp:Mode` und treffen Sie Ihre Auswahl im Dropdown-Menü.
...
1. Klicken Sie auf das „MCP Servers“-Icon in der oberen Navigationsleiste des Caret-Bereichs.
...
_Beispiel für eine MCP-Server-Konfiguration in Caret (STDIO Transport)_
...
Nach der Konfiguration eines MCP-Servers erkennt Caret automatisch verfügbare Tools und Ressourcen. Um diese zu nutzen:

1. Geben Sie Ihre Anfrage im Konversationsfenster von Caret ein
2. Caret erkennt, wann ein MCP-Tool bei Ihrer Aufgabe helfen kann
