...
<Note>
캐럿(Caret) 기준 문서입니다. Caret은 프로바이더 설정 검증 및 UX가 강화되어 있습니다. 계정/조직 정책에 따라 허용 모델이 달라질 수 있습니다.
</Note>
...
3. **키 생성:** 새 API 키를 생성하고 식별 가능한 이름(예: "Caret")을 지정합니다.
...
1. **Caret 설정 열기:** Caret 패널의 설정 아이콘(⚙️) 클릭
