...
description: "Codestral 모델을 사용하여 LiteLLM을 Caret과 함께 설정하고 실행하는 방법을 알아보세요. 이 가이드는 Docker 설정, 구성 및 Caret과의 통합을 다룹니다."
---
...
Caret은 LiteLLM을 포함한 프로바이더 설정에 **자동 모델 조회 기능**을 추가했습니다.
