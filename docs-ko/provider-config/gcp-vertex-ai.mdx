...
다음 단계를 따르면 엔터프라이즈 팀은 GCP Vertex AI를 Caret VS Code 확장 프로그램과 안전하게 통합하여 **Claude 3.5 Sonnet v2**의 기능을 활용할 수 있습니다.
