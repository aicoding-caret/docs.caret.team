...
<BrandName particle="topic" /> Cline Memory Bank 방식 대신 **이중 디렉토리 아키텍처**를 사용합니다.
...
| Memory Bank 파일 | <BrandName /> 대체 위치 |
| --- | --- |
...
- [<BrandName /> 규칙](/ko/features/caret-rules)
