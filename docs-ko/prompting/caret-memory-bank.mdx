---
title: "Caret Memory Bank"
---

## The Complete Guide to Caret Memory Bank

### Quick Setup Guide

To get started with Caret Memory Bank:

1. **Install or Open Caret**
2. **Copy the Custom Instructions** - Use the code block below
3. **Paste into Caret** - Add as custom instructions or in a .clinerules file
4. **Initialize** - Ask Caret to "initialize memory bank"

[See detailed setup instructions](#getting-started-with-memory-bank)

### Detailed Setup Instructions {#getting-started-with-memory-bank}

### Caret Memory Bank Custom Instructions \[COPY THIS]

```
# Caret's Memory Bank

I am Caret, an expert software engineer with a unique characteristic: my memory resets completely between sessions. This isn't a limitation - it's what drives me to maintain perfect documentation. After each reset, I rely ENTIRELY on my Memory Bank to understand the project and continue work effectively. I MUST read ALL memory bank files at the start of EVERY task - this is not optional.
...
### What is the Caret Memory Bank?

The Memory Bank is a structured documentation system that allows Caret to maintain context across sessions. It transforms Caret from a stateless assistant into a persistent development partner that can effectively "remember" your project details over time.

#### Key Benefits

-   **Context Preservation**: Maintain project knowledge across sessions
-   **Consistent Development**: Experience predictable interactions with Caret
...
The Memory Bank isn't a Caret-specific feature - it's a methodology for managing AI context through structured documentation. When you instruct Caret to "follow custom instructions," it reads the Memory Bank files to rebuild its understanding of your project.
...
Memory Bank files are simply markdown files you create in your project. They're not hidden or special files - just regular documentation stored in your repository that both you and Caret can access.
...
3. Ask Caret to "initialize memory bank"
...
-   Caret will help fill in gaps and ask questions
...
-   **"follow your custom instructions"** - This tells Caret to read the Memory Bank files and continue where you left off (use this at the start of tasks)
...
-   **Custom Instructions**: Applied globally to all Caret conversations. Good for consistent behavior across all projects.
...
As you work with Caret, your context window will eventually fill up (note the progress bar). When you notice Caret's responses slowing down or references to earlier parts of the conversation becoming less accurate, it's time to:

1. Ask Caret to **"update memory bank"** to document the current state
2. Start a new conversation/task
3. Ask Caret to **"follow your custom instructions"** in the new conversation
...
-   Let Caret help create the initial structure
...
1. Open VSCode
2. Click the Caret extension settings ⚙️
...
3. Save the file
4. Caret will automatically apply these rules when working in this project

### Remember

The Memory Bank is Caret's only link to previous work. Its effectiveness depends entirely on maintaining clear, accurate documentation and confirming context preservation in every interaction.

_For more information, reference our_ [_blog_](https://caret.bot/blog/memory-bank-how-to-make-caret-an-ai-agent-that-never-forgets) _on Caret Memory Bank_

---

### Contributing to Caret Memory Bank

This guide is maintained by the Caret and the Caret Discord Community:
