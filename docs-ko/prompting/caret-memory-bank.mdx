---
title: "Careti 컨텍스트 시스템"
description: "Memory Bank를 대체하는 Caret의 이중 디렉토리 아키텍처를 안내합니다."
---

# Careti 컨텍스트 시스템

Caret은 Cline Memory Bank 방식 대신 **이중 디렉토리 아키텍처**를 사용합니다.
...
- [Careti 규칙](/ko/features/caret-rules)
