...
이 문서는 Self-Hosted 배포용 LiteLLM 구성 가이드입니다. 웹 기반 설정은 [LiteLLM SaaS 구성](/enterprise-solutions/configuration/remote-configuration/litellm/admin-configuration)을 참고하세요.
</Info>
...
LiteLLM 설정에 모델이 등록되어 있는지 확인하세요. Caret 구성의 모델 ID는 LiteLLM 모델 이름과一致해야 합니다.
