...
이 문서는 Self-Hosted 배포용 Bedrock 구성 가이드입니다. 웹 기반 설정은 [AWS Bedrock SaaS 구성](/ko/enterprise-solutions/configuration/remote-configuration/aws-bedrock/admin-configuration)을 참고하세요.
</Info>
