...
Workflows는 [Rules](/ko/enterprise-solutions/configuration/infrastructure-configuration/rules)와 유사하지만 차이가 있습니다.
...
<Tabs>
  <TabItem value="manual" title="수동 생성">
  ...
  <TabItem value="slash-command" title="슬래시 명령">
...
<CardGroup cols={2}>
  <Card title="Rules" icon="book" href="/ko/enterprise-solutions/configuration/infrastructure-configuration/rules">
    항상 활성 규칙 이해하기
  </Card>
  
  <Card title="원격 구성" icon="cloud" href="/ko/enterprise-solutions/configuration/remote-configuration/overview">
    전역 워크플로 배포
  </Card>
</CardGroup>
