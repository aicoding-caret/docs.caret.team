...
<CardGroup cols={2}>
  <Card title="MCP 마켓플레이스" icon="store" href="/ko/enterprise-solutions/configuration/infrastructure-configuration/mcp/mcp-marketplace">
    사전 구성된 MCP 서버를 기업 환경에 맞게 배포
  </Card>
  
  <Card title="원격 MCP 서버" icon="server" href="/ko/enterprise-solutions/configuration/infrastructure-configuration/mcp/remote-mcp-servers">
...
<Tabs>
<TabItem value="development" title="Development">
```yaml
# mcp-dev-config.yaml
mcp:
...
<TabItem value="production" title="Production">
```yaml
...
1. [MCP 마켓플레이스](/ko/enterprise-solutions/configuration/infrastructure-configuration/mcp/mcp-marketplace)
2. [원격 MCP 서버](/ko/enterprise-solutions/configuration/infrastructure-configuration/mcp/remote-mcp-servers)
3. [MCP 개발 가이드](/ko/mcp/mcp-overview)
