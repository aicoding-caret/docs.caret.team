...
<Tabs>
  <TabItem value="newrule" title="/newrule 사용">
...
<CardGroup cols={2}>
  <Card title="Workflows" icon="diagram-project" href="/ko/enterprise-solutions/configuration/infrastructure-configuration/workflows">
    규칙과 워크플로 조합하기
  </Card>
