...
> 🚀 **MCP 서버를 구축하고 전 세계와 공유하십시오.** 훌륭한 MCP 서버를 만들었다면 [캐러티 MCP 마켓플레이스](https://github.com/caret/mcp-marketplace)에 제출하여 수천 명의 개발자가 검색하고 원클릭으로 설치할 수 있도록 하십시오.
...
구축하려는 내용을 명확하게 설명하여 캐러티 채팅을 시작합니다. 다음 사항에 대해 구체적으로 설명하십시오.
