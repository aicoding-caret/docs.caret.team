...
> 🚀 **MCP 서버를 구축하고 전 세계와 공유하십시오.** 훌륭한 MCP 서버를 만들었다면 [Caret MCP 마켓플레이스](https://github.com/caret/mcp-marketplace)에 제출하여 수천 명의 개발자가 검색하고 원클릭으로 설치할 수 있도록 하십시오.
...
효과적인 MCP 서버 개발의 핵심은 구조화된 프로토콜을 따르는 것입니다. 이 프로토콜은 MCP 작업 디렉토리의 **루트**(/Users/your-name/Documents/Caret/MCP)에 있는 `.agents/context` 파일을 통해 구현됩니다.
