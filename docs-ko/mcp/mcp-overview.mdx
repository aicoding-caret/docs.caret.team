...
-   [GitHub에서 MCP 서버 구축](/ko/mcp/adding-mcp-servers-from-github)
-   [처음부터 사용자 지정 MCP 서버 구축](/ko/mcp/mcp-server-development-protocol)
...
-   **커뮤니티 저장소:** GitHub에서 커뮤니티에서 유지 관리하는 MCP 서버 목록을 확인하십시오. [GitHub에서 MCP 서버 추가](/ko/mcp/adding-mcp-servers-from-github) 참조
-   **<BrandName /> 마켓플레이스:** Cline의 [MCP 마켓플레이스](/ko/mcp/mcp-marketplace)에서 설치하십시오.
