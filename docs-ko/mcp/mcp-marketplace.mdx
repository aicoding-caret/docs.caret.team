---
title: "MCP를 쉽게"
description: "캐러티의 기능을 추가 도구 및 리소스로 향상시키는 MCP 서버를 검색, 설치 및 구성하기 위해 MCP 마켓플레이스를 사용하는 방법을 알아보십시오."
---
...
-   서버 코드는 `/Users/<사용자 이름>/Documents/캐러티/MCP/`에 복제/설치됩니다.
-   종속성이 설치됩니다.
...
-   서버를 제거하고 다시 설치해 보십시오(`cline_mcp_settings.json` 파일과 `/Users/<사용자 이름>/Documents/캐러티/MCP/` 디렉토리 모두에서 제거).
