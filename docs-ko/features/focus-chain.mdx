...
1. Careti 설정(⚙️) → **Features**에서 **Enable Focus Chain** 활성화  
...
Focus Chain works seamlessly with Careti's [Plan/Act mode](/ko/features/plan-and-act):
...
Still stuck? Use the [/reportbug](/ko/features/slash-commands/report-bug) command in Careti to get help.
