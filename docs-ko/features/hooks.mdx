...
title: "훅"
sidebarTitle: "훅"
description: "Careti 워크플로우에 커스텀 로직을 주입해 작업 검증, 도구 사용 모니터링, AI 결정 흐름을 제어합니다."
---
...
- 레거시 경로: `~/Documents/Careti/Hooks/` (폴백 지원)
...
- [Careti 규칙](/ko/features/caret-rules)으로 상위 가이드를 정의하고 훅으로 강제할 수 있습니다
