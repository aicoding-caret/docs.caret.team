...
- [Caret Rules](/ko/features/caret-rules) define high-level guidance that hooks can enforce
- [Checkpoints](/ko/features/checkpoints) let you roll back changes if a hook didn't catch an issue
- [Auto-Approve](/ko/features/auto-approve) works well with hooks as safety nets for automated operations
