...
각 Hook의 트리거 조건과 테스트 방법은 [Hook 레퍼런스](/features/hooks/hook-reference) 문서를 참고하세요.
</Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Hook 레퍼런스" icon="book" href="/features/hooks/hook-reference">
...
Hooks는 [Caret CLI](/caret-cli/overview)에서도 사용할 수 있습니다. CLI 실행 시 Hooks를 켜거나 끌 수 있습니다:
...
- [Caret Rules](/features/caret-rules) - Hooks가 규칙을 강제하도록 설계
- [체크포인트](/features/checkpoints) - 문제 발생 시 롤백
- [자동 승인](/features/auto-approve) - 자동화 작업에 안전망 제공
- [Caret CLI](/caret-cli/overview) - 터미널/자동화 환경에서 Hooks 사용
