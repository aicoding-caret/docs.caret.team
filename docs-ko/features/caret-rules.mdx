...
Caret의 시스템 프롬프트는 사용자가 편집할 수 없습니다([여기에서 확인](https://github.com/caret/caret/blob/main/src/core/prompts/system.ts)). 프롬프트 엔지니어링 모범 사례는 [이 리소스](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview)를 참고하세요.
