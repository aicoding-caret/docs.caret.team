...
<Tip>
명령과 플래그의 세부 내용은 [CLI 레퍼런스](/ko/caret-cli/cli-reference)에서 확인할 수 있습니다.
</Tip>
...
<Columns cols={2}>
  ...
  <Card title="Plan and Act" icon="brain" href="/ko/features/plan-and-act">
  ...
  <Card title="작업 관리" icon="clipboard-check" href="/ko/features/tasks/task-management">
