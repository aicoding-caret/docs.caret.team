---
title: "3가지 핵심 흐름"
description: "Careti CLI를 사용하는 세 가지 방법: 대화형 모드, 헤드리스 자동화, 멀티 인스턴스 병렬화"
---
...
**인스턴스(Instance)** - 독립적인 Careti 작업 공간입니다. 각 인스턴스는 한 번에 하나의 작업만 실행합니다. 여러 인스턴스를 만들어 프로젝트의 다른 영역을 병렬로 처리할 수 있습니다.
...
- **대화형 모드**: 새로운 문제를 탐색하거나 Careti 동작을 익힐 때, 또는 실행 전 계획을 검토하고 싶을 때
