...
<Tip>
New to Caret CLI? Start with interactive mode (`caret`) to see how it works. Once comfortable, explore [the three core flows](/ko/caret-cli/three-core-flows) for advanced usage patterns.
</Tip>
