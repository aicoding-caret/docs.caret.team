---
title: "CLI 레퍼런스"
description: "설정, 인스턴스 관리, 작업 명령까지 Careti CLI 전체 명령어 참조"
---

Careti CLI의 전체 명령어 레퍼런스입니다. 모든 명령, 옵션, 설정에 대한 상세 문서를 확인할 수 있습니다.
...
Careti CLI의 전체 매뉴얼 페이지 예시입니다(영문 출력 그대로 표시):
