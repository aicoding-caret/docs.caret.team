...
<Note>
**Caret CLI가 처음인가요?** 이 샘플은 Caret CLI 기본 사용법을 알고 있고 [설치 가이드](/ko/caret-cli/installation)를 완료했다는 전제입니다. 처음이라면 더 간단한 [GitHub RCA 샘플](./github-issue-rca)부터 시작하는 것을 권장합니다.
</Note>
...
- **Caret CLI 지식** - [설치 가이드](/ko/caret-cli/installation) 완료 및 기본 사용법 이해
