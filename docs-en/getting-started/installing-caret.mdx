...
<CardGroup cols={1}>
  <Card title="Create Your Account" icon="user-plus" href="https://app.caret.bot/signup">
    Sign up for a **free Careti account** to get:
...
<Tabs>
  <TabItem title="VS Code/Cursor" value="vs-code-cursor" icon="code">
    ...
    <Steps>
      ...
      <Step title="Search for Careti">
        Type **"Careti"** in the Extensions marketplace search bar
        	<Frame>
      ...
      <Step title="Install">
        Click the **Install** button on the Careti extension
      ...
      <Step title="Access Careti">
        ...
        - Click the **Careti icon** in the Activity Bar, or
        - Open Command Palette (`Ctrl/Cmd + Shift + P`) → type **"Careti: Open In New Tab"**
        ...
        <Warning>
        If VS Code shows "Running extensions might..." dialog, click **Allow**. If you don't see the Careti icon, restart VS Code.
        </Warning>
      </Step>
    </Steps>

    <Check>
    **Installation Complete!** You should now see the Careti interface in your editor. Time to sign in!
    </Check>
    ...
    **Plugin Installation Issues**
    ...
    If you can't find Careti in the marketplace:
    - Make sure you're searching in the **Marketplace** tab (not Installed)
    - Try searching for "Careti AI" or just "Careti"
    ...
    **Plugin Not Appearing**
    ...
    If you don't see the Careti tool window after installation:
    - Restart VS Code completely (File → Exit and reopen)
    - Check **View** → **Command Palette** → "Careti: Open In New Tab"
    - Verify the plugin is enabled in **Extensions** view
    - Look for the Careti icon in your Activity Bar (usually on the left side)
  ...
  <TabItem title="JetBrains IDEs" value="jetbrains-ides" icon="brain">
    ...
    <Note>
    Careti for JetBrains works almost identically to VS Code, with all core features: diff editing, tools, multiple API providers, MCP servers, Careti rules/workflows, and more.
    </Note>
      ...
      <TabItem title="From IDE (Recommended)" value="from-ide">
        <Steps>
          ...
          <Step title="Install Careti">
            Search for **"Careti"** and click **Install**
    ...
    <Check>
    **Installation Complete!** Find Careti in **View** → **Tool Windows** → **Careti** (usually on the right side).
    </Check>
    ...
    **Plugin Not Appearing**
    ...
    - Check **View** → **Tool Windows** → **Careti**
    - Verify the plugin is enabled in **Settings** → **Plugins** → **Installed** tab
    - Look for the Careti icon in your IDE's tool window bar (usually on the right side)
  ...
  <TabItem title="VSCodium/Windsurf" value="vscodium-windsurf" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Search for Careti">
        Type **"Careti"** in the marketplace search bar
      </Step>

      <Step title="Install by Author">
        Select **"Careti" by saoudrizwan** and click **Install**
      </Step>
    ...
    <Check>
    **Installation Complete!** Look for the Careti icon in your Activity Bar or use the Command Palette.
    </Check>
...
<Steps>
  <Step title="Open Careti">
    Find and open Careti in your editor:
    - **VS Code/Cursor/VSCodium/Windsurf:** Click the Careti icon in the Activity Bar
    - **JetBrains:** Go to **View** → **Tool Windows** → **Careti**
  </Step>

  <Step title="Sign In">
    Click the **Sign Up** button in the Careti interface
  ...
  <Step title="You're All Set!">
    <Check>
    **Congratulations!** You're all set to start using Careti! 
    
    Careti is now ready to help you build projects. 
    </Check>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Ask Questions" icon="circle-question">
    Don't know something? Ask in Plan Mode! Careti can explain concepts, debug errors, and guide you through tasks.
  </Card>
  ...
  <Card title="Speak Naturally" icon="comments">
    Use your own words—no need for technical jargon. Careti will translate your ideas into code.
  </Card>
</CardGroup>
