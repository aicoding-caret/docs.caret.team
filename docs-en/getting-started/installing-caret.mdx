...
description: "Get Caret up and running in your favorite IDE with these simple installation steps"
---
...
<Tabs>
  <TabItem title="VS Code/Cursor" value="vs-code-cursor" icon="code">
    ...
    <Steps>
      ...
      <Step title="Access Caret">
        After installation completes:
        - Click the **Caret icon** in the Activity Bar, or
        - Open Command Palette (`Ctrl/Cmd + Shift + P`) → type **"Caret: Open In New Tab"**
    ...
    **Common Issues**
    ...
    Need help? Join our [Discord community](https://discord.gg/caret).
...
<Steps>
  ...
  <Step title="Sign In">
    ...
    <Frame>
            <img src="/assets/installation/login.png" alt="Caret sign up screen" 
            />
          </Frame>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Join Our Discord" icon="discord" href="https://discord.gg/caret">
