...
description: "Get started with your first AI model in Caret"
---
...
Caret needs an AI model to understand your requests and write code. Think of it like choosing which expert to work with - different models have different strengths and costs.

## Quick Start: Choose Your Provider

The easiest way to get started is with **Caret** as your provider:

1. **Open Caret Settings**: Click the gear icon (⚙️) in the top-right corner of Caret's chat
2. **Select "Caret"** from the API Provider dropdown
...
<Tip>
**Free models available**: Caret occasionally offers free inferencing through partner providers. When available, you'll see these options in your model dropdown.
</Tip>
...
2. Paste it into the API Key field in Caret settings
3. Choose your model
...
With your model configured, you're all set! In the next section, we'll walk you through completing your first task with Caret and show you how to interact with the AI to write, debug, and refactor code.
