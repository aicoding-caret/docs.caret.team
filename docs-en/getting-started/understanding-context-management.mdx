...
- **Context** = All information <BrandName /> knows about your project
- **Context Window** = Maximum information <BrandName /> can process at once (varies by model)
- **Token** = Unit of text measurement (~3/4 of an English word)
- **Auto-management** = <BrandName /> automatically handles context through Focus Chain & Auto Compact
</Info>

## What is Context Management?

Context management is how <BrandName /> maintains understanding of your project throughout a conversation. Think of it as the shared memory between you and <BrandName /> - containing code, decisions, requirements, and progress.
...
## How <BrandName /> Builds Context

Building effective context is what makes <BrandName /> truly useful. When you start a task, <BrandName /> doesn't just passively wait for information - he actively gathers context about your project, asks clarifying questions when needed, and adapts to what's happening in real-time. This combination of automatic discovery, user guidance, and dynamic adaptation ensures <BrandName /> always has the right information to solve your problems effectively.

### 1. Automatic Context Gathering

When you start a task, <BrandName /> proactively:
...
**What <BrandName /> automatically discovers:**
...
While automatic discovery handles much of the work, you control what <BrandName /> focuses on. The more specific and relevant context you provide, the better <BrandName /> can understand your needs and deliver accurate solutions.
...
- **Answering questions** when <BrandName /> needs clarification

### 3. Dynamic Context Adaptation

<BrandName /> adapts context dynamically throughout your conversation. It considers the complexity of your request, available context window space, current task progress, error messages and feedback, plus previous decisions made during the conversation to determine what information matters most at each step.
...
If your conversation approaches the model's context window limit before Auto Compact runs, <BrandName />'s Context Manager automatically truncates older parts of the conversation to prevent errors.
...
This happens automatically. You'll keep working without interruption, and <BrandName /> maintains enough context to continue solving your problem effectively.

## Best Practices

- **Be specific** - Clear objectives help <BrandName /> understand your needs
...
- **Use the <BrandName /> Context System** - Keep AGENTS.md + .agents/context + caret-docs aligned
