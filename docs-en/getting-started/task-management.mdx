...
description: "Learn how to effectively manage your task history, use favorites, and organize your work in Caret."
---

# Task Management

As you use Caret, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the Caret sidebar
2. Using the command palette to search for "Caret: Show Task History"
...
Task management helps you maintain an organized workflow when using Caret, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
