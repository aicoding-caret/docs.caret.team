...
Caret automatically handles context limits with [auto-compact](/features/auto-compact). When you approach your model's limit, Caret summarizes the conversation to keep working. You don't need to micromanage this.
