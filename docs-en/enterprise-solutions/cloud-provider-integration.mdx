...
Caret supports major cloud providers like AWS Bedrock and Google's Cloud Vertex; whichever your team currently uses is appropriate, and there's no need to change providers to utilize Caret's features.
...
3. Note the IP address of your VPC endpoint, open Caret's settings menu, and select `AWS Bedrock`from the API Provider dropdown.
