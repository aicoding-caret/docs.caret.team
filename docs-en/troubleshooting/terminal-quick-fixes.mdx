...
-   Select **"WSL Bash"** in <BrandName /> settings, under **"Terminal Settings"**
-   Increase **"Shell integration timeout (seconds)"** to **15**

## Full Guide

For detailed troubleshooting, see the [Complete Terminal Troubleshooting Guide](/en/troubleshooting/terminal-integration-guide).
