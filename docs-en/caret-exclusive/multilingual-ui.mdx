...
Code comfortably in your native language. <BrandName /> provides true multilingual support with fully translated UI and documentation.

## Supported Languages

<BrandName /> perfectly supports 4 languages:
...
<BrandName /> automatically detects VS Code language settings:
...
Select directly in <BrandName /> settings:
...
- ✅ Input placeholder: "How can <BrandName /> help you?"
...
- **Korean**: https://docs.careti.ai/ko
- **English**: https://docs.careti.ai/en
- **Japanese**: https://docs.careti.ai/ja
- **Chinese**: https://docs.careti.ai/zh

### Auto-Redirection

When clicking documentation links from <BrandName /> UI:
...
**Complete multilingual UI is exclusive to <BrandName />.** Cline only supports English.
