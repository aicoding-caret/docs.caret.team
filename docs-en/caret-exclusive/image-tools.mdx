...
<BrandName />'s AI can **generate** and **analyze** images.
...
| Tool | Requirements |
|------|----------|
| `generate_image` | <BrandName /> login required |
| `analyze_image` | <BrandName /> login required (text models only) |
...
1. **Authentication Required**: Image tools require <BrandName /> login
