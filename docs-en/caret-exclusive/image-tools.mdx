...
sidebar_position: 11
title: ^ Image Tools
description: A Caret-exclusive feature that enables AI to generate and analyze images
---

# ^ Image Tools

Caret's AI can **generate** and **analyze** images.
...
| Tool | Requirements |
|------|----------|
| `generate_image` | Caret login required |
| `analyze_image` | Caret login required (text models only) |
...
1. **Authentication Required**: Image tools require Caret login
