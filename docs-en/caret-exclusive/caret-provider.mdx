...
1. Ask Careti to generate an image (e.g., "Create an illustration for a dashboard").
2. Careti calls the image generation API and produces the result.
...
- You can instruct Careti to move generated assets into **specific project folders** for organized management.
