...
description: Learn about Caret's core system that ensures AI accurately follows your team's rules and standards.
---

# ^ AI Organization Knowledge & Rules Standardization

Caret is designed so that AI **accurately understands and follows your team's coding rules and standards**. Through this system, AI functions as a true team member that understands project context, not just a simple code generation tool.

## Why Is Knowledge Synchronization Important?

| Situation | Generic AI Tools | Caret |
|---|---|---|
...
Caret acknowledges that **documents for AI and humans serve different purposes**. To address this, it uses two directories:
...
Caret uses an **Atomic Knowledge** approach. Instead of a single massive document, knowledge is broken into minimal units (Atoms) and combined as needed.
...
Caret uses the **`.agents/context/`** folder as the single source of rules. This ensures AI follows consistent standards across the entire project.
...
| **Global Rules** | `Documents/Caret/Rules` | Apply to all projects |
...
3. Start chatting with Caret

For detailed rule writing guidelines, see the [Caret Rules Feature](/en/features/caret-rules) documentation.

## Related Documentation

- [Caret Rules Feature](/en/features/caret-rules) - Rule writing guide
