...
For detailed rule writing guidelines, see the [Careti Rules Feature](/en/features/caret-rules) documentation.

## Related Documentation

- [Careti Rules Feature](/en/features/caret-rules) - Rule writing guide
