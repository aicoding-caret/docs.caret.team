...
|----------|-----------------|---------|---------------|---------|
| **<BrandName />** | Multiple | Credit-based | High | In-app |
...
- **Simplicity**: <BrandName /> (no API key management)
...
Real-time usage data from the <BrandName /> community:
- View current trends at [OpenRouter's <BrandName /> stats](https://openrouter.ai/apps?url=https%3A%2F%2Fcline.bot%2F)
