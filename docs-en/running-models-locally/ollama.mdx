...
Open VS Code and configure Caret:

1. Click the Caret settings icon
...
For the best experience with Caret, use **Qwen3 Coder 30B**. This model provides strong coding capabilities and reliable tool use for local development.
...
For better performance with local models, enable compact prompts in Caret settings. This reduces the prompt size by 90% while maintaining core functionality.
