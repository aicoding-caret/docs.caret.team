---
title: "Caret Context System (Memory Bank Replacement)"
---

# Caret Context System (Memory Bank Replacement)

Caret **fully replaces** the Cline Memory Bank approach.  
Instead, Caret manages project context through **`AGENTS.md` + `.agents/context` + `caret-docs` + `work-logs`**.
...
## Why Caret Replaced Memory Bank (Caret Advantages)
...
- [Caret Rules](/en/features/caret-rules)
