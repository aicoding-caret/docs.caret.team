...
<Callout type="tip">
**New to model selection?** Start with [Module 2 of Caret's Learning Path](https://caret.bot/learn) for a comprehensive guide to choosing and configuring models.
</Callout>
...
|----------|----------|-------|
| **Caret** | Easiest setup | No API keys needed, access to multiple models including stealth models |
...
Check [OpenRouter's Caret usage stats](https://openrouter.ai/apps?url=https%3A%2F%2Fcline.bot%2F) to see real usage patterns from the community.
