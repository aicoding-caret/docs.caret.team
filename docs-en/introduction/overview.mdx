...
<AccordionGroup>
  ...
  <Accordion title="Workflow Optimization" icon="bolt">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      ...
      <div>
        <strong><a href="/features/dictation">Dictation</a></strong> • Speak naturally to Caret for rapid planning and complex requirements
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Extensions & Integrations" icon="plug">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      ...
      <div>
        <strong><a href="/exploring-carets-tools/remote-browser-support">Remote Browser</a></strong> • Test and interact with web applications through browser automation
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Customization & Control" icon="gear">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      <div>
        <strong><a href="/features/caret-rules">.agents/context</a></strong> • Define project-specific instructions including coding standards and patterns
      </div>
      <div>
