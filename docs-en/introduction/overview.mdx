---
title: "Overview"
description: "An introduction to Caret, your AI-powered coding agent for modern development."
---
...
<Tabs>
  ...
  <TabItem title="Act Mode" value="act-mode" icon="play">
    Once you approve the plan, Caret implements the solution with full transparency and control.
...
<AccordionGroup>
  ...
  <Accordion title="Workflow Optimization" icon="bolt">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      ...
      <div>
        <strong><a href="/en/features/dictation">Dictation</a></strong> • Speak naturally to Caret for rapid planning and complex requirements
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Customization & Control" icon="gear">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      <div>
        <strong><a href="/en/features/caret-rules">Caret Rules</a></strong> • Define project-specific guidelines
      </div>
      <div>
