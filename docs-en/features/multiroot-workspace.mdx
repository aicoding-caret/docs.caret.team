...
2. **Start using Caret** - Caret will automatically detect all your workspace folders and interact with them as needed.
...
- Caret attempts to intelligently determine which workspace a file belongs to
...
When working with large multiroot workspaces, start in [Plan mode](/en/features/plan-and-act) to let Caret understand your project structure before making changes.
