---
title: "Disable Terminal Pagers During Caret Sessions"
description: "Make CLI output non-interactive when Caret runs commands by detecting the CLINE_ACTIVE environment variable and disabling pagers like less."
---
...
- If you prefer environment variables, many CLIs also respect a generic or tool-specific pager variable:
  ...
  - Man pages: `MANPAGER=cat` (not typically needed for Caret-driven commands)
