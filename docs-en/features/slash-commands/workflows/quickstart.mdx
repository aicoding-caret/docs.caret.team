...
description: "A step-by-step guide to creating your first Caret workflow"
---
...
<Steps>
  ...
  <Step title="Run the workflow">
    ...
    1. Open the Caret chat panel
    2. Type `/pr-review.md` followed by the PR number (e.g., `/pr-review.md 42`)
    3. Caret fetches PR details, analyzes the code, and shows findings

    <Tip>
      When Caret runs commands like `gh pr view`, it may pause to show output. Click **Proceed While Running** to let Caret continue.
    </Tip>
  </Step>
</Steps>
...
Look for repetitive tasks in your workflow and turn them into efficient Caret workflows.
