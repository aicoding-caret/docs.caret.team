...
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`caret.addToChat`](/en/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Careti chat              |
| [`caret.addTerminalOutputToChat`](/en/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Careti                 |
