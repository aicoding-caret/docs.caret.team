...
Plan & Act modes represent Careti's approach to structured AI development, emphasizing thoughtful planning before implementation. This dual-mode system helps developers create more maintainable, accurate code while reducing iteration time.
...
Plan mode is where you and Careti figure out what you're trying to build and how you'll build it. In this mode, Careti:
...
Once you've got a plan, you switch to Act mode. Now Careti:
...
1. I start in Plan mode and tell Careti what I want to build
2. Careti helps me explore the codebase, looking at relevant files
...
5. Careti implements the solution based on our planning
...
-   Let Careti analyze relevant files
...
3. Point Careti to relevant files if he hasn't read them
...
-   Have Careti write markdown files of the plan for future reference
