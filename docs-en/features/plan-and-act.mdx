...
Plan & Act modes represent <BrandName />'s approach to structured AI development, emphasizing thoughtful planning before implementation. This dual-mode system helps developers create more maintainable, accurate code while reducing iteration time.
...
Plan mode is where you and <BrandName /> figure out what you're trying to build and how you'll build it. In this mode, <BrandName />:
...
Once you've got a plan, you switch to Act mode. Now <BrandName />:
...
1. I start in Plan mode and tell <BrandName /> what I want to build
2. <BrandName /> helps me explore the codebase, looking at relevant files
...
5. <BrandName /> implements the solution based on our planning
...
-   Let <BrandName /> analyze relevant files
...
3. Point <BrandName /> to relevant files if he hasn't read them
...
-   Have <BrandName /> write markdown files of the plan for future reference
