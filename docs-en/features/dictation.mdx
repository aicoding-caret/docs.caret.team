---
title: "Dictation"
description: "Communicate with Caret using your voice for faster, more natural AI collaboration"
---
...
Use Dictation constantly in [Plan mode](/en/features/plan-and-act) for rapid back-and-forth discussions. Instead of typing careful, structured prompts, think about a problem. Caret asks clarifying questions, respond immediately, and iterate until having a solid plan.
...
3. Sign into your Caret account when prompted
4. Install FFmpeg if you haven't already (Caret will guide you)
