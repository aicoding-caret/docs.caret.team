...
:::tip
  Focus Chain works particularly well with Caret's [Deep Planning slash command](/en/features/slash-commands/deep-planning), providing seamless progress tracking for implementation tasks created through the [planning process](/en/features/plan-and-act).
:::
...
<Steps>
  <Step title="Open Caret Settings">
...
Focus Chain works seamlessly with Caret's [Plan/Act mode](/en/features/plan-and-act):
...
Still stuck? Use the [/reportbug](/en/features/slash-commands/report-bug) command in Caret to get help.
