...
Focus Chain is a task management enhancement feature in Careti that provides automatic todo list management with real-time progress tracking throughout your tasks. 
...
This enables Careti to work on long-horizon tasks, seamlessly managing the context sent to LLMs, and keeping Careti on track across many context window resets.

:::tip
  Focus Chain works particularly well with Careti's [Deep Planning slash command](/en/features/slash-commands/deep-planning), providing seamless progress tracking for implementation tasks created through the [planning process](/en/features/plan-and-act).
:::
...
Careti analyzes your task and automatically creates a comprehensive todo list with:
...
- Seamless integration back into Careti's workflow
...
<Steps>
  <Step title="Open Careti Settings">
      - Click the gear icon in the Careti sidebar
      - Navigate to the "Features" section
  </Step>
  <Step title="Enable Focus Chain">
      - Check "Enable Focus Chain"
      - Optionally adjust "Remind Careti Interval" (default: 6 messages)
  </Step>
  <Step title="Start a New Task">
      - Begin a new task
      - Careti will automatically start creating and managing todo lists
  </Step>
</Steps>
...
| Remind Careti Interval | 6 | 1-100 messages | How often Careti updates the todo list |
...
Careti creates a comprehensive plan for the task, stored in a markdown file:
...
As Careti works, the task header shows real-time progress:
...
<Steps>
  ...
  <Step title="Save the file">
    Careti automatically detects and uses your updates
  </Step>
</Steps>
...
Focus Chain works seamlessly with Careti's [Plan/Act mode](/en/features/plan-and-act):
...
Still stuck? Use the [/reportbug](/en/features/slash-commands/report-bug) command in Careti to get help.
