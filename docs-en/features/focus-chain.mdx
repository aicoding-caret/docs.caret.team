...
Focus Chain is a task management enhancement feature in <BrandName /> that provides automatic todo list management with real-time progress tracking throughout your tasks. 
...
This enables <BrandName /> to work on long-horizon tasks, seamlessly managing the context sent to LLMs, and keeping <BrandName /> on track across many context window resets.

:::tip
  Focus Chain works particularly well with <BrandName />'s [Deep Planning slash command](/en/features/slash-commands/deep-planning), providing seamless progress tracking for implementation tasks created through the [planning process](/en/features/plan-and-act).
:::
...
<BrandName /> analyzes your task and automatically creates a comprehensive todo list with:
...
- Seamless integration back into <BrandName />'s workflow
...
<Steps>
  <Step title="Open Careti Settings">
      - Click the gear icon in the <BrandName /> sidebar
      - Navigate to the "Features" section
  </Step>
  <Step title="Enable Focus Chain">
      - Check "Enable Focus Chain"
      - Optionally adjust "Remind <BrandName /> Interval" (default: 6 messages)
  </Step>
  <Step title="Start a New Task">
      - Begin a new task
      - <BrandName /> will automatically start creating and managing todo lists
  </Step>
</Steps>
...
| Remind <BrandName /> Interval | 6 | 1-100 messages | How often <BrandName /> updates the todo list |
...
<BrandName /> creates a comprehensive plan for the task, stored in a markdown file:
...
As <BrandName /> works, the task header shows real-time progress:
...
<Steps>
  ...
  <Step title="Save the file">
    <BrandName /> automatically detects and uses your updates
  </Step>
</Steps>
...
Focus Chain works seamlessly with <BrandName />'s [Plan/Act mode](/en/features/plan-and-act):
...
:::info
  :::details Accordion
    ...
    2. **Review Generated Lists**
      - Check that <BrandName />'s breakdown aligns with your expectations
  ...
  :::details Accordion
    ...
    3. **Regular Reviews**
      ...
      - Communicate changes to <BrandName /> through edits
  :::
  :::details Accordion
    1. **Share Todo Files**
...
Still stuck? Use the [/reportbug](/en/features/slash-commands/report-bug) command in <BrandName /> to get help.
...
Focus Chain turns <BrandName /> into your personal project manager, keeping you on track and your tasks organized. Give it a try on your next project!
