...
description: "Automated GitHub issue analysis using Caret CLI to identify root causes."
---
...
<Note>
**New to Caret CLI?** This sample assumes you have already completed the [Installation Guide](https://docs.caret.bot/caret-cli/installation) and authenticated with `caret auth`. If you haven't set up Caret CLI yet, please start there first.
</Note>
...
- **Caret CLI** installed and authenticated ([Installation Guide](https://docs.caret.bot/caret-cli/installation))
...
1. **Building autonomous CLI tools** using Caret's capabilities
2. **Parsing structured JSON output** from Caret CLI
