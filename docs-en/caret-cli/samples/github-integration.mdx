...
<Note>
**New to Caret CLI?** This sample assumes you understand Caret CLI basics and have completed the [Installation Guide](https://docs.caret.bot/caret-cli/installation). If you're new to Caret CLI, we recommend starting with the [GitHub RCA sample](/en/caret-cli/samples/github-issue-rca) first, as it's simpler and will help you understand the fundamentals before setting up GitHub Actions.
</Note>
