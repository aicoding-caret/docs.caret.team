---
title: "CLI Reference"
description: "Complete command reference for Careti CLI including configuration, instance management, and task commands"
---

Complete command reference for <BrandName /> CLI. Use this for detailed documentation on all commands, options, and configuration.
...
The complete manual page for the <BrandName /> CLI:
...
Override the default <BrandName /> directory location:
