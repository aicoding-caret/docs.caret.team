...
Complete command reference for Careti CLI. Use this for detailed documentation on all commands, options, and configuration.
...
The complete manual page for the Careti CLI:
...
Override the default Careti directory location:
