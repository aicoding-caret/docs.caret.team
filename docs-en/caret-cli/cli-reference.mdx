---
title: "CLI Reference"
description: "Complete command reference for Caret CLI including configuration, instance management, and task commands"
---

Complete command reference for Caret CLI. Use this for detailed documentation on all commands, options, and configuration.
...
The complete manual page for the Caret CLI:
...
Override the default Caret directory location:
