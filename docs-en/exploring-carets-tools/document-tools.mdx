...
<Note>
These tools are Caret-exclusive features.
</Note>

Caret provides powerful tools that allow AI to directly analyze images and documents. Thanks to these tools, AI can read and analyze files just by their path, without users having to manually attach them.
...
- **Caret Account Login Required**: Image analysis is processed through the Caret API
...
- [Caret Tools Guide](/en/exploring-carets-tools/caret-tools-guide)
