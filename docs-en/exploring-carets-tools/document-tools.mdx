...
<Note>
These tools are <BrandName />-exclusive features.
</Note>

<BrandName /> provides powerful tools that allow AI to directly analyze images and documents. Thanks to these tools, AI can read and analyze files just by their path, without users having to manually attach them.
...
- **<BrandName /> Account Login Required**: Image analysis is processed through the <BrandName /> API
...
- [<BrandName /> Tools Guide](/en/exploring-carets-tools/caret-tools-guide)
