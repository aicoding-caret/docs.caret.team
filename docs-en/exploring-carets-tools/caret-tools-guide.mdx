---
title: "Careti Tools Reference Guide"
---

## What Can <BrandName /> Do?

<BrandName /> is your AI assistant that can:
...
3. **Review Changes**
    - <BrandName /> will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [<BrandName /> repository](https://github.com/caret/caret/blob/main/src/core/prompts/system-prompt/tools).

<BrandName /> has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that <BrandName /> can then access
    - Example: Create a weather API tool that <BrandName /> can use to fetch forecasts
...
-   Provide feedback to improve <BrandName />
