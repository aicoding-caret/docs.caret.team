...
Careti is your AI assistant that can:
...
3. **Review Changes**
    - Careti will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Careti repository](https://github.com/caret/caret/blob/main/src/core/prompts/system-prompt/tools).

Careti has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Careti can then access
    - Example: Create a weather API tool that Careti can use to fetch forecasts
...
-   Provide feedback to improve Careti
