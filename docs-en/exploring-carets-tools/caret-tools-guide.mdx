---
title: "Caret Tools Reference Guide"
---

## What Can Caret Do?

Caret is your AI assistant that can:
...
3. **Review Changes**
    - Caret will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Caret repository](https://github.com/caret/caret/blob/main/src/core/prompts/system-prompt/tools).

Caret has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Caret can then access
    - Example: Create a weather API tool that Caret can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/caret)
-   Check the documentation
-   Provide feedback to improve Caret
