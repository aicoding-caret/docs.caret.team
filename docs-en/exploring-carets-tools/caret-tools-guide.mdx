...
For the most up-to-date implementation details, you can view the full source code in the [Caret repository](https://github.com/caret/caret/blob/main/src/core/Caret.ts).
