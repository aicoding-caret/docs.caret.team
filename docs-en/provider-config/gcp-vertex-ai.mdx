---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with Careti to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
-   **Install the <BrandName /> Extension:**
    -   Open VS Code
    -   Navigate to the Extensions Marketplace (Ctrl+Shift+X or Cmd+Shift+X)
    -   Search for **<BrandName />** and install the extension
...
-   **Open <BrandName /> Settings:**\
    Click the settings ⚙️ icon within the <BrandName /> extension
-   **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the <BrandName /> extension picks up the new credentials
...
4. **Set the Environment Variable:**
    ...
    - This instructs Google Cloud client libraries (and <BrandName />) to use this key
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the <BrandName /> VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
-   **Configure <BrandName /> in VS Code:**\
    Install <BrandName />, enter your project ID, select the appropriate region, and choose the model
...
_This guide will be updated as GCP Vertex AI and <BrandName /> evolve. Always refer to the latest documentation for current practices._
