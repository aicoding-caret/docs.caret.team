---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM-4.5 models with Careti. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
- Works exclusively through coding tools like Careti
...
To use the GLM Coding Plans with Careti:
...
3. **Configure in Careti:** Open Careti settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="Careti settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to Careti, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
