---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM-4.5 models with Caret. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
- Works exclusively through coding tools like Caret
...
To use the GLM Coding Plans with Caret:
...
3. **Configure in Caret:** Open Caret settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="Caret settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to Caret, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
