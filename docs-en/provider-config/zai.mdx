...
- Works exclusively through coding tools like <BrandName />
...
To use the GLM Coding Plans with <BrandName />:
...
3. **Configure in <BrandName />:** Open <BrandName /> settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.
...
The setup connects your subscription directly to <BrandName />, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
