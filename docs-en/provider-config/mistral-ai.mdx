---
title: "Mistral"
description: "Learn how to configure and use Mistral AI models, including Codestral, with Caret. Covers API key setup and model selection."
---
...
1.  **Select "Mistral" as the API Provider in Caret Settings.**
2.  **Select a Codestral Model** (e.g., `codestral-latest`) from the "Model" dropdown.
3.  **Enter your Codestral API Key** (from `codestral.mistral.ai`) or your La Plateforme API Key (from `api.mistral.ai`) into the appropriate API key field in Caret.
