---
title: "LiteLLM & Careti (using Codestral)"
description: "Learn how to set up and run LiteLLM with Careti using the Codestral model. This guide covers Docker setup, configuration, and integration with Careti."
---

### Using LiteLLM with <BrandName />

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with <BrandName />.
...
2. **Setup <BrandName />**
    ...
    Once the LiteLLM server is up and running you can set it up in <BrandName />:
