...
### Using LiteLLM with Careti

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Careti.
...
2. **Setup Careti**
    ...
    Once the LiteLLM server is up and running you can set it up in Careti:
