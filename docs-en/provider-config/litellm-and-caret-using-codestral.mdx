---
title: "LiteLLM & Caret (using Codestral)"
description: "Learn how to set up and run LiteLLM with Caret using the Codestral model. This guide covers Docker setup, configuration, and integration with Caret."
---

### Using LiteLLM with Caret

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Caret.
...
2. **Setup Caret**
    ...
    Once the LiteLLM server is up and running you can set it up in Caret:
