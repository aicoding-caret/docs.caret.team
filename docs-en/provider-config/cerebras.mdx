---
title: "Cerebras"
description: "Learn how to configure and use Cerebras's ultra-fast inference with Caret. Experience up to 2,600 tokens per second with wafer-scale chip architecture and real-time reasoning models."
---
