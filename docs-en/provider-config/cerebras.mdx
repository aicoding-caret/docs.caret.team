...
Careti supports the following Cerebras models:
...
#### No IDE Lock-In
Works with any OpenAI-compatible tool—Cursor, Continue.dev, Careti, or any other editor that supports OpenAI endpoints.
