---
title: "Claude Code"
description: "Use your Claude Max or Pro subscription with Caret instead of paying per token. Learn how to set up and configure the Claude Code provider."
---
...
<figure>
	<img
		...
		alt="Using the Claude Code provider in Caret with Opus model"
	/>
</figure>
