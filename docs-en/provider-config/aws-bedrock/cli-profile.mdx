...
4. If you haven't already done so, install VSCode and the <BrandName /> extension. Consult the [Getting Started](/en/getting-started/installing-caret) page for guidance.
