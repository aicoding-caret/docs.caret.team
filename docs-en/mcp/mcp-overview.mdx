...
Careti does not come with any pre-installed MCP servers. You'll need to find and install them separately.
...
-   **Careti Marketplace:** Install one from Careti's [MCP Marketplace](/en/mcp/mcp-marketplace)
-   **Ask Careti:** You can ask Careti to help you find or create MCP servers
...
## Integration with Careti

Careti simplifies the building and use of MCP servers through its AI capabilities.

### Building MCP Servers

-   **Natural language understanding:** Instruct Careti in natural language to build an MCP server by describing its functionalities. Careti will interpret your instructions and generate the necessary code.
-   **Cloning and building servers:** Careti can clone existing MCP server repositories from GitHub and build them automatically.
-   **Configuration and dependency management:** Careti handles configuration files, environment variables, and dependencies.
-   **Troubleshooting and debugging:** Careti helps identify and resolve errors during development.

### Using MCP Servers

-   **Tool execution:** Careti seamlessly integrates with MCP servers, allowing you to execute their defined tools.
-   **Context-aware interactions:** Careti can intelligently suggest using relevant tools based on conversation context.
-   **Dynamic integrations:** Combine multiple MCP server capabilities for complex tasks. For example, Careti could use a GitHub server to get data and a Notion server to create a formatted report.
