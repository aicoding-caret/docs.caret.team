...
For detailed information on configuring STDIO and SSE transports in Careti, including examples, see [Configuring MCP Servers](/en/mcp/configuring-mcp-servers).
