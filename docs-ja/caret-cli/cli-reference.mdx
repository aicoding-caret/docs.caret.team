---
title: "CLI リファレンス"
description: "設定、インスタンス管理、タスクコマンドを含む Careti CLI の完全なリファレンス"
---

<BrandName /> CLI の全コマンドリファレンスです。すべてのコマンド、オプション、設定の詳細を確認できます。

ターミナルで簡易ヘルプを見るには:

```bash
caret --help          # すべてのコマンドを表示
caret task --help     # タスク関連コマンド
man caret            # フルマニュアル
```

## マニュアルページ

<BrandName /> CLI の完全なマニュアルページ例です(英語出力のまま表示):
