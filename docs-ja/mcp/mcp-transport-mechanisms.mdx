...
For detailed information on configuring STDIO and SSE transports in <BrandName />, including examples, see [Configuring MCP Servers](/ja/mcp/configuring-mcp-servers).
