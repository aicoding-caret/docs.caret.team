---
title: "SAP AI Core"
description: "Learn how to configure and use LLM models from Generative AI Hub in SAP AI Core with Careti."
---
...
- **Service Plan Requirement:** You must have the SAP AI Core `extended` service plan to use LLMs with Careti. Other service plans do not provide access to Generative AI Hub.
