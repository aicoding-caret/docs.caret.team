...
description: "Use Vercel AI Gateway in Caret to reach 100+ models from one endpoint with routing, retries, and spend observability."
---
...
4. Pick a model from the list. Caret fetches the catalog automatically. You can also paste an exact id
