...
description: "IAM アクセスキーとシークレットキー認証情報を使用して AWS Bedrock を Careti でセットアップします。確立された IAM ポリシーを持つ企業環境に最適です。"
---
...
-   **<BrandName />:** AI モデルと統合してコード生成、デバッグ、データ分析を可能にする VS Code 拡張機能であるコーディングアシスタント。
