...
ワークフローは [Caret Rules](/ja/features/caret-rules) と並んで存在します。作成は簡単です：

<figure>
	<img src="https://storage.googleapis.com/cline_public_images/docs/assets/workflows.png" alt="Caret のワークフロータブ" />
</figure>
...
-   `ask_followup_question`、`read_file`、`search_files`、`new_task` などの Caret の [組み込みツール](/ja/exploring-carets-tools/caret-tools-guide) を活用
