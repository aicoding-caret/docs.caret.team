...
まず [create-new-workflow.md](https://github.com/caretive-ai/project-careti/blob/main/prompts/workflows/create-new-workflow.md) をワークスペースに保存します (例: `.agents/context/workflows/`).
