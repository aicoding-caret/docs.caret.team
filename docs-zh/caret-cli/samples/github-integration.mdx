...
description: "在 GitHub Actions 中使用 Caret CLI，通过 @caret 自动回复 Issue"
---
...
<Note>
**第一次使用 Caret CLI？** 本示例假设你已完成 [安装指南](/zh/caret-cli/installation)。建议先看更简单的 [GitHub RCA 示例](/zh/caret-cli/samples/github-issue-rca)。
</Note>
...
- **已掌握 Caret CLI** ([安装指南](/zh/caret-cli/installation))
...
该工作流会检测 `@caret` 提及，启动 Caret CLI 实例进行分析并回复。
