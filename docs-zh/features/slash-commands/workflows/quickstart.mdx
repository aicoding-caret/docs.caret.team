...
title: "工作流快速开始"
sidebarTitle: "快速开始"
description: "创建你的第一个 Caret 工作流的分步指南"
---
...
<Steps>
  ...
  <Step title="运行工作流">
    ...
    3. Caret 会获取 PR 信息、分析代码并展示结果

    <Tip>
      当 Caret 执行 `gh pr view` 等命令时可能会暂停显示输出，请点击 **Proceed While Running** 继续。
    </Tip>
  </Step>
</Steps>
...
在你的项目中寻找重复性工作，并将它们转化为高效的 Caret 工作流。
