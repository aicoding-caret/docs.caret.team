...
| 命令 ID                                                                               | 描述                                   |
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`caret.openInNewTab`](/zh/features/commands-and-shortcuts/overview)                        | 在新编辑器选项卡中打开 Caret               |
| [`caret.addToChat`](/zh/features/commands-and-shortcuts/code-commands)                      | 将选定代码添加到 Caret 聊天              |
| [`caret.addTerminalOutputToChat`](/zh/features/commands-and-shortcuts/terminal-integration) | 将终端输出添加到 Caret                 |
