...
| 命令 ID                                                                               | 描述                                   |
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`caret.openInNewTab`](/features/commands-and-shortcuts/overview)                        | 在新编辑器选项卡中打开 Caret               |
| [`caret.addToChat`](/features/commands-and-shortcuts/code-commands)                      | 将选定代码添加到 Caret 聊天              |
| [`caret.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | 将终端输出添加到 Caret                 |
| `caret.focusChatInput`                                                                   | 聚焦 Caret 聊天输入字段            |
| [`caret.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | 为暂存的更改生成提交消息 |
| [`caret.explainCode`](/features/commands-and-shortcuts/code-commands)                    | 解释选定的代码                        |
| [`caret.improveCode`](/features/commands-and-shortcuts/code-commands)                    | 为选定代码建议改进       |
| [`caret.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | 修复有错误的代码                        |
