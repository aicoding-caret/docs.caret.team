...
title: "Hooks"
sidebarTitle: "Hooks"
description: "在 Caret 工作流中注入自定义逻辑，验证操作、监控工具使用并影响 AI 决策。"
---

<Note>
本文以 Caret 为基准，遵循 Caret v3.38.1 合并版本。如有 Hook 范围、认证/路由、日志/遥测差异，会以 `<Note>` 标注。
</Note>

<Note>
Caret 账号/组织 Hooks 可能包含账号信息，参见 `caret-docs/features/f04-caret-account.md`。日志/遥测使用 `caret-src/utils/`。
</Note>
...
- [Caret Rules](/zh/features/caret-rules)
