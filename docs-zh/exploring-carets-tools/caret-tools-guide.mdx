...
有关最新的实现细节，您可以在 [Careti 仓库](https://github.com/caret/caret/blob/main/src/core/Careti.ts)中查看完整的源代码。

Careti 可以访问以下工具来执行各种任务：
...
3. **MCP 工具**
    ...
    - 用户可以创建 Careti 随后可以访问的自定义 MCP 工具
    - 示例：创建一个 Careti 可以用来获取天气预报的天气 API 工具
