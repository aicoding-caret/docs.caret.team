...
-   Select **"WSL Bash"** in Caret settings, under **"Terminal Settings"**
-   Increase **"Shell integration timeout (seconds)"** to **15**

## Full Guide

For detailed troubleshooting, see the [Complete Terminal Troubleshooting Guide](/zh/troubleshooting/terminal-integration-guide).
