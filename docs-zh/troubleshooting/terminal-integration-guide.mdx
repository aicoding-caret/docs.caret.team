...
title: "终端集成故障排除指南"
sidebarTitle: "终端故障排除"
description: "解决 Careti 中终端集成问题的完整指南"
---

本指南帮助您解决 <BrandName /> 中的终端集成问题。终端集成对于 <BrandName /> 执行命令并读取其输出至关重要，使其能够理解错误、测试结果和命令响应。

:::tip
	如果您遇到终端问题，请尝试在 <BrandName /> 设置的"终端设置"下切换到更简单的 shell，如 `bash`
