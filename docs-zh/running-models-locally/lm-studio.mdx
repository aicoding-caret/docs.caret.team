---
title: "LM Studio"
description: "使用 Caret 设置 LM Studio 进行本地 AI 模型执行的快速指南。"
---

## 🤖 使用 Caret 设置 LM Studio

使用 LM Studio 和 Caret 在本地运行 AI 模型。
...
<figure>
	<img
		...
		alt="使用 LM Studio 配置 Caret"
	/>
</figure>

### ⚠️ 重要说明

-   在与 Caret 一起使用之前启动 LM Studio
-   保持 LM Studio 在后台运行
