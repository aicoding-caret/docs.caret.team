...
<br />
	...
	normally](#setup) and make sure you have the latest Claude Code and Caret versions.
...
**Still having trouble?** We're actively improving this integration. Report issues on our [GitHub](https://github.com/caret/caret/issues) or ask for help in our [Discord](https://discord.gg/caret).
