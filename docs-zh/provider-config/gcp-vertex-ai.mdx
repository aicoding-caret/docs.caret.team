---
title: "GCP Vertex AI"
description: "配置 GCP Vertex AI 与 Caret，以访问 Claude 3.5 Sonnet v2 等领先的生成式 AI 模型。本指南涵盖 GCP 环境设置、身份验证和企业团队的安全集成。"
---
...
4. **设置环境变量：**
    ...
    - 这会指示 Google Cloud 客户端库（和 Caret）使用此密钥
...
通过遵循这些步骤，您的企业团队可以安全地将 GCP Vertex AI 与 Caret VS Code 扩展集成，以利用 **Claude 3.5 Sonnet v2** 的强大功能：
...
-   **在 VS Code 中配置 Caret：**\
    安装 Caret，输入您的项目 ID，选择适当的区域，并选择模型
-   **设置身份验证：**\
...
_本指南将随着 GCP Vertex AI 和 Caret 的发展而更新。请始终参考最新文档以了解当前实践。_
