---
title: "SAP AI Core"
description: "了解如何配置和使用来自 SAP AI Core 中生成式 AI Hub 的 LLM 模型与 Careti。"
---
...
1. **访问：** 通过 [BTP Cloud Cockpit](https://cockpit.btp.cloud.sap/cockpit) 访问您的子账户
...
- **服务计划要求：** 您必须拥有 SAP AI Core `extended` 服务计划才能将 LLM 与 <BrandName /> 一起使用。其他服务计划不提供对生成式 AI Hub 的访问。
