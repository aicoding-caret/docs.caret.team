...
### 将 LiteLLM 与 <BrandName /> 一起使用

本指南演示了如何运行 LiteLLM 的演示，从 Codestral 模型开始，以便与 <BrandName /> 一起使用。
...
2. **设置 <BrandName />**
    ...
    一旦 LiteLLM 服务器启动并运行，您可以在 <BrandName /> 中进行设置：
...
-   [<BrandName /> Discord 社区](https://https://discord.gg/WB6yaR89YN)
