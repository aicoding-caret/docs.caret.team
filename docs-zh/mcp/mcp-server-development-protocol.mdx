...
> 🚀 **构建并与世界分享您的 MCP 服务器。** 创建出色的 MCP 服务器后，将其提交到 [Careti MCP 市场](https://github.com/caret/mcp-marketplace)，使其可被数千名开发人员发现并一键安装。
...
资源使您的 MCP 服务器更具上下文感知能力，允许 Careti 访问特定信息而无需您复制/粘贴。有关更多信息，请参阅[官方文档](https://modelcontextprotocol.io/docs/concepts/resources)。
