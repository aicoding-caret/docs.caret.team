...
description: "Les raccourcis clavier de Caret vous permettent d'accéder à l'assistance de l'IA sans lâcher votre clavier. Accélérez votre flux de travail en utilisant des raccourcis pour les actions courantes de Caret."
---

Les raccourcis clavier de Caret vous permettent d'accéder à l'assistance de l'IA sans lâcher votre clavier. Accélérez votre flux de travail en utilisant des raccourcis pour les actions courantes de Caret.

## Raccourcis clavier par défaut

Caret est livré avec les raccourcis clavier intégrés suivants pour rationaliser votre flux de travail :

| Action                  | Windows/Linux | macOS   | Condition                            | Description                                            |
| ----------------------- | ------------- | ------- | ------------------------------------ | ------------------------------------------------------ |
| Ajouter à Caret         | `Ctrl+'`      | `Cmd+'` | Lorsqu'un texte est sélectionné     | Ajoute le code sélectionné au chat Caret               |
| Focus sur la saisie Chat | `Ctrl+'`      | `Cmd+'` | Lorsqu'aucun texte n'est sélectionné | Met le focus sur le champ de saisie du chat Caret     |
...
Bien que Caret ne dispose que de quelques raccourcis clavier par défaut, vous pouvez attribuer vos propres raccourcis à l'une de ces commandes :

| ID de commande                                                                             | Description                                        |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------- |
| [`caret.addToChat`](/french/features/commands-and-shortcuts/code-commands)                   | Ajoute le code sélectionné au chat Caret          |
| [`caret.addTerminalOutputToChat`](/french/features/commands-and-shortcuts/terminal-integration) | Ajoute la sortie du terminal à Caret              |
| `caret.focusChatInput`                                                                    | Met le focus sur le champ de saisie du chat Caret  |
...
| `claude-dev.SidebarProvider.focus`                                                        | Ouvre et met le focus sur la sidebar Caret        |

## Personnalisation des raccourcis clavier

Vous pouvez personnaliser les raccourcis clavier de Caret en fonction de vos préférences :
...
2. Recherchez "Caret" pour voir toutes les commandes disponibles
...
| ------------------------- | ------------------------------------ | ------------------------------------------- | --------------------------------------- |
| Ouvrir la Sidebar Caret   | `Ctrl+Shift+C` / `Cmd+Shift+C`       | `claude-dev.SidebarProvider.focus`          | Ouvre le panneau de la sidebar Caret    |
| Nouvelle Tâche             | `Alt+N`                              | `caret.plusButtonClicked`                   | Démarre une nouvelle tâche Caret        |
| Ajouter Terminal à Caret | `Alt+T`                              | `caret.addTerminalOutputToChat`             | Ajoute la sortie du terminal à Caret    |
...
Avec les bons raccourcis, vous pouvez utiliser Caret sans jamais toucher la souris :

1. Sélectionnez le code avec la navigation au clavier (touches `Shift+Flèche`)
2. Envoyez à Caret avec `Ctrl+'` / `Cmd+'`
...
Les raccourcis clavier de Caret s'intègrent parfaitement aux raccourcis intégrés de VS Code :

-   Utilisez les raccourcis de sélection de VS Code (`Ctrl+L` / `Cmd+L` pour sélectionner la ligne, etc.) avant d'envoyer du code à Caret
-   Combinez avec les raccourcis de l'éditeur divisé de VS Code pour afficher le code et Caret côte à côte
...
Les raccourcis clavier peuvent sembler être une petite optimisation, mais ils peuvent considérablement accélérer votre flux de travail lorsque vous utilisez Caret régulièrement. En gardant vos mains sur le clavier, vous maintenez votre flux de codage tout en obtenant une assistance de l'IA exactement au moment où vous en avez besoin.

## Comment trouver toutes les commandes disponibles

Pour voir toutes les commandes Caret auxquelles des raccourcis peuvent être attribués :

1. Ouvrez la Palette de commandes (`Ctrl+Shift+P` / `Cmd+Shift+P`)
2. Tapez "Caret" pour filtrer la liste
