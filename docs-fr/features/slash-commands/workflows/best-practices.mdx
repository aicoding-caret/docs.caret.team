...
description: "Conseils et stratégies pour créer des flux de travail Caret efficaces et fiables"
---
...
## Création de flux de travail avec Caret

Caret comprend le contexte de votre projet, ce qui en fait un excellent partenaire pour la conception de flux de travail.
...
Ensuite, exécutez `/create-new-workflow.md` et Caret vous guidera à travers :
...
<Tip>
  **Automatisez vos journaux de travail :** Les tâches terminées sont d'excellents candidats pour les flux de travail. Une fois que vous avez terminé une tâche, demandez "Transforme ce que je viens de faire en un flux de travail", et Caret analysera la conversation et générera un fichier de flux de travail.
</Tip>

Stockez les flux de travail spécifiques au projet dans `.agents/context/workflows/` et les flux de travail globaux dans `~/Documents/Caret/Workflows/`. En cas de conflit de noms, les flux de travail de projet sont prioritaires.
...
Comme pour le code, il est important d'expliquer **pourquoi**. De bons commentaires aident Caret et votre équipe à comprendre l'intention.
...
## Conception d'invites pour Caret
...
Les flux de travail structurés sont plus faciles à suivre pour Caret. Utilisez des sections telles que :
