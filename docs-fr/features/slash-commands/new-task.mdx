...
-   Caret analysera votre conversation et proposera une version distillée du contexte à conserver
...
Plutôt que de perdre ces informations ou de repartir de zéro, j'utilise `/newtask` pour que Caret extrait ce qui compte - les décisions clés, les modifications de fichiers et les progrès réalisés jusqu'à présent - sans tout le bruit des appels d'outils individuels et des étapes de recherche.
