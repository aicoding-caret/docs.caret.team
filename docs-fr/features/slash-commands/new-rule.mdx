...
-   Careti vous aidera à créer un fichier de règles structuré en vous posant des questions sur vos préférences pour :
...
-   Une fois approuvé, Careti crée un fichier markdown dans votre répertoire `.agents/context` qui sera automatiquement chargé pour les conversations futures.
