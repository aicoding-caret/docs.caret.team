...
Focus Chain est une fonctionnalité d'amélioration de la gestion des tâches dans Caret qui offre une gestion automatique de la liste de tâches avec un suivi de la progression en temps réel tout au long de vos tâches. 
...
Cela permet à Caret de travailler sur des tâches à long terme, en gérant de manière transparente le contexte envoyé aux LLMs, et en maintenant Caret sur la bonne voie malgré les nombreuses réinitialisations de la context window.

:::tip
  Focus Chain fonctionne particulièrement bien avec la [Deep Planning slash command](/french/features/slash-commands/deep-planning) de Caret, offrant un suivi de progression fluide pour les tâches d'implémentation créées via le [planning process](/french/features/plan-and-act).
:::
...
Caret analyse votre tâche et crée automatiquement une liste de tâches complète avec :
...
- Intégration transparente dans le workflow de Caret
...
<Steps>
  <Step title="Ouvrir les paramètres de Caret">
      - Cliquez sur l'icône d'engrenage dans la barre latérale de Caret
      - Naviguez vers la section "Features"
  </Step>
  <Step title="Activer Focus Chain">
      - Cochez "Enable Focus Chain"
      - Ajustez éventuellement le "Remind Caret Interval" (par défaut : 6 messages)
  </Step>
  <Step title="Démarrer une nouvelle tâche">
      - Commencez une nouvelle tâche
      - Caret commencera automatiquement à créer et à gérer des listes de tâches
  </Step>
</Steps>
...
| Remind Caret Interval | 6 | 1-100 messages | Fréquence à laquelle Caret met à jour la liste de tâches |
...
Caret crée un plan complet pour la tâche, stocké dans un fichier markdown :
...
À mesure que Caret travaille, l'en-tête de la tâche affiche la progression en temps réel :
...
<Steps>
  ...
  <Step title="Enregistrer le fichier">
    Caret détecte et utilise automatiquement vos mises à jour
  </Step>
</Steps>
...
Focus Chain fonctionne de manière transparente avec le [Plan/Act mode](/french/features/plan-and-act) de Caret :
...
:::info
  :::details Accordion
    ...
    2. **Réviser les listes générées**
      - Vérifiez que la décomposition de Caret correspond à vos attentes
  ...
  :::details Accordion
    ...
    3. **Révisions régulières**
      ...
      - Communiquez les changements à Caret via des modifications
  :::
  :::details Accordion
...
Toujours bloqué ? Utilisez la commande [/reportbug](/french/features/slash-commands/report-bug) dans Caret pour obtenir de l'aide.
...
Focus Chain transforme Caret en votre gestionnaire de projet personnel, vous permettant de rester sur la bonne voie et de garder vos tâches organisées. Essayez-le pour votre prochain projet !