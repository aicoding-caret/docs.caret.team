...
description: Découvrez le système central de Caret qui garantit que l'IA suit précisément les règles et les standards de votre équipe.
---

# ^ Standardisation des règles et des connaissances de l'organisation pour l'IA

Caret est conçu pour que l'IA **comprenne et suive précisément les règles et les standards de codage de votre équipe**. Grâce à ce système, l'IA fonctionne comme un véritable membre de l'équipe qui comprend le contexte du projet, et pas seulement comme un simple outil de génération de code.

## Pourquoi la synchronisation des connaissances est-elle importante ?

| Situation | Outils d'IA génériques | Caret |
|---|---|---|
...
Caret reconnaît que les **documents destinés à l'IA et aux humains répondent à des besoins différents**. Pour résoudre cela, il utilise deux répertoires :
...
Caret utilise une approche de **Connaissances Atomiques**. Au lieu d'un seul document massif, les connaissances sont divisées en unités minimales (Atomes) et combinées selon les besoins.
...
Caret utilise le dossier **`.agents/context/`** comme source unique de vérité pour les règles. Cela garantit que l'IA suit des standards cohérents dans tout le projet.
...
| **Règles globales** | `Documents/Caret/Rules` | S'applique à tous les projets |
...
3. Commencez à discuter avec Caret

Pour des directives détaillées sur la rédaction des règles, consultez la documentation sur la [Fonctionnalité des règles Caret](/french/features/caret-rules).

## Documentation associée

- [Fonctionnalité des règles Caret](/french/features/caret-rules) - Guide de rédaction des règles
