...
-   **Démarrer une nouvelle tâche :** "Careti, commençons une nouvelle tâche. Crée `user-authentication.js`. Nous devons implémenter l'authentification utilisateur avec des jetons JWT. Voici les prérequis…"
-   **Résumer le travail précédent :** "Careti, résume ce que nous avons fait dans la dernière tâche du tableau de bord utilisateur. Je veux capturer les fonctionnalités principales et les problèmes restants. Enregistre cela dans `caret_docs/user-dashboard-summary.md`."
...
-   **Vérification de la mémoire** - _pacnpal_
    ...
    Un moyen amusant de vérifier que Careti reste sur la bonne voie pendant les tâches complexes. Essayez "HO HO HO" pour une variante festive !
