...
---
title: "Référence CLI"
description: "Référence complète des commandes pour Careti CLI, incluant la configuration, la gestion d'instance et les commandes de tâches"
---

Référence complète des commandes pour Careti CLI. Utilisez ceci pour une documentation détaillée sur toutes les commandes, options et configurations.

Pour une aide rapide dans votre terminal :

```bash
caret --help          # Show all commands
caret task --help     # Show task-specific commands
man caret            # View the full manual page
```

## Page de Manuel

La page de manuel complète pour le Careti CLI :
...
Générez des scripts d'auto-complétion pour divers shells :
...
Remplacez l'emplacement par défaut du répertoire Careti :
...
Ce répertoire est utilisé pour :
- Base de données du registre des instances
