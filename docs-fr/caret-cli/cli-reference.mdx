...
---
title: "Référence CLI"
description: "Référence complète des commandes pour Caret CLI, incluant la configuration, la gestion d'instance et les commandes de tâches"
---

Référence complète des commandes pour Caret CLI. Utilisez ceci pour une documentation détaillée sur toutes les commandes, options et configurations.
...
La page de manuel complète pour le Caret CLI :
...
Remplacez l'emplacement par défaut du répertoire Caret :
