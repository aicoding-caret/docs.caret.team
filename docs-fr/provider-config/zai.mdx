---
title: "Z AI (Zhipu AI)"
description: "Découvrez comment configurer et utiliser les modèles GLM-4.5 de Z AI avec Caret. Profitez d'un raisonnement hybride avancé, de capacités d'agent et de l'excellence de l'open-source avec une optimisation régionale."
---
...
- Fonctionne exclusivement via des outils de codage comme Caret
...
Pour utiliser les forfaits de codage GLM avec Caret :
...
3. **Configurer dans Caret :** Ouvrez les paramètres de Caret, sélectionnez "Z AI" comme fournisseur et collez votre clé API dans le champ "Z AI API Key".

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="Paramètres de Caret avec le fournisseur zAI sélectionné et le champ de la clé API mis en évidence" />
</Frame>

La configuration connecte votre abonnement directement à Caret, vous donnant accès aux capacités d'appel d'outils de GLM-4.5 optimisées pour les flux de travail de codage.
