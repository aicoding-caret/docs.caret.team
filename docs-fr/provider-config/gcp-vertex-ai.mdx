---
title: "GCP Vertex AI"
description: "Configurez GCP Vertex AI avec Caret pour accéder aux modèles d'IA générative de pointe comme Claude 3.5 Sonnet v2. Ce guide couvre la configuration de l'environnement GCP, l'authentification et l'intégration sécurisée pour les équipes d'entreprise."
---
...
-   **Ouvrir les paramètres de Caret :**\
    Cliquez sur l'icône des paramètres ⚙️ dans l'extension Caret
...
3. **Redémarrer VS Code :**\
   Assurez-vous de redémarrer VS Code pour que l'extension Caret puisse récupérer les nouveaux identifiants
...
4. **Définir la variable d'environnement :**
    ...
    - Cela indique aux bibliothèques clientes Google Cloud (et à Caret) d'utiliser cette clé
...
En suivant ces étapes, votre équipe d'entreprise peut intégrer en toute sécurité GCP Vertex AI avec l'extension Caret pour VS Code afin d'exploiter la puissance de **Claude 3.5 Sonnet v2** :
...
-   **Configurez Caret dans VS Code :**\
    Installez Caret, saisissez votre Project ID, sélectionnez la Region appropriée et choisissez le modèle
...
_Ce guide sera mis à jour au fur et à mesure de l'évolution de GCP Vertex AI et de Caret. Référez-vous toujours à la documentation la plus récente pour les pratiques actuelles._