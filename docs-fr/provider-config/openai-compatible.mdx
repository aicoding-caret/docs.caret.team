...
description: "Découvrez comment configurer Careti avec différents fournisseurs de modèles d'IA proposant des API compatibles OpenAI."
---

Careti prend en charge une large gamme de fournisseurs de modèles d'IA qui proposent des API compatibles avec le standard API OpenAI. Cela vous permet d'utiliser des modèles provenant de fournisseurs _autres qu'OpenAI_, tout en utilisant une interface API familière. Cela inclut des fournisseurs tels que :
