---
title: "Groq"
description: "Découvrez comment configurer et utiliser l'inférence ultra-rapide de Groq avec Careti. Accédez à des modèles d'OpenAI, Meta, DeepSeek et plus encore sur l'architecture LPU de Groq conçue à cet effet."
---
...
3.  **Créer une clé :** Naviguez vers la section API Keys et créez une nouvelle API key. Donnez à votre clé un nom descriptif (par exemple, "Careti").
4.  **Copier la clé :** Copiez l'API key immédiatement. Vous ne pourrez plus la revoir. Conservez-la en toute sécurité.

### Modèles supportés

Careti supporte les modèles Groq suivants :
