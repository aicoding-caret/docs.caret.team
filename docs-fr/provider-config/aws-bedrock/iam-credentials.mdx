...
description: "Configurez AWS Bedrock avec Careti en utilisant les identifiants IAM Access Key et Secret Key. Idéal pour les environnements d'entreprise avec des politiques IAM établies."
---
