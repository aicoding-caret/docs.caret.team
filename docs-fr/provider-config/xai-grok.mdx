---
title: "xAI (Grok)"
description: "Découvrez comment configurer et utiliser les modèles Grok d'xAI avec Careti, incluant la configuration de la clé API, les modèles supportés et les capacités de raisonnement."
---
...
3.  **Créer une clé :** Cliquez pour créer une nouvelle API key. Donnez à votre clé un nom descriptif (par ex., "Careti").
4.  **Copier la clé :** **Important :** Copiez l'API key _immédiatement_. Vous ne pourrez plus la revoir. Conservez-la en lieu sûr.

### Modèles supportés

Careti supporte les modèles xAI Grok suivants :
