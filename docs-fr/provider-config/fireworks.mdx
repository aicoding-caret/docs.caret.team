---
title: "Fireworks AI"
description: "Découvrez comment configurer et utiliser la plateforme d'inference ultra-rapide de Fireworks AI avec Caret. Bénéficiez de vitesses d'inference jusqu'à 4 fois plus rapides grâce à des modèles optimisés et une tarification compétitive."
---
...
1.  **Ouvrir les réglages de Caret :** Cliquez sur l'icône des paramètres (⚙️) dans le panneau de Caret.
