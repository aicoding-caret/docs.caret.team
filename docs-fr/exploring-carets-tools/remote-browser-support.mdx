...
description: "La prise en charge du navigateur distant permet à Careti d'utiliser une instance Chrome distante, en tirant parti des jetons d'authentification et des cookies de session pertinents pour certains cas de test de développement Web."
---
...
## Navigateur distant dans Careti
