```yaml
---
title: "Guide de référence des outils Caret"
description: "Découvrez les outils disponibles dans Caret et comment les utiliser efficacement pour vos tâches de développement."
---

## Que peut faire Caret ?

Caret est votre assistant IA qui peut :
...
3. **Vérifier les modifications**
    - Caret affichera les diffs avant d'effectuer des modifications
...
Pour obtenir les détails d'implémentation les plus récents, vous pouvez consulter le code source complet dans le [référentiel Caret](https://github.com/caret/caret/blob/main/src/core/prompts/system-prompt/tools).

Caret a accès aux outils suivants pour diverses tâches :
...
3. **Outils MCP**
    ...
    - Les utilisateurs peuvent créer des outils MCP personnalisés auxquels Caret peut ensuite accéder
    - Exemple : Créer un outil d'API météo que Caret peut utiliser pour extraire les prévisions
...
-   Fournir des commentaires pour améliorer Caret
```