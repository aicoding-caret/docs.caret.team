...
description: "Этот протокол разработан для оптимизации процесса разработки MCP server-ов с помощью Careti."
---

> **Создавайте и делитесь своими MCP server-ами со всем миром.** Как только вы создадите отличный MCP server, отправьте его в [Careti MCP Marketplace](https://github.com/caret/mcp-marketplace), чтобы сделать его доступным и устанавливаемым одним щелчком мыши для тысяч разработчиков.
...
Resources делают ваши MCP server-ы более осведомленными о контексте, позволяя Careti получать доступ к определенной информации без необходимости копировать/вставлять. Для получения дополнительной информации обратитесь к [официальной документации](https://modelcontextprotocol.io/docs/concepts/resources).
