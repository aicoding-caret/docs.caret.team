...
description: "Как настроить и управлять вашими MCP servers в Caret."
---

## Глобальный режим включения MCP Server

Использование MCP servers увеличит расход ваших токенов. Caret предлагает возможность ограничить или отключить функциональность MCP server по вашему желанию.

1. Нажмите на иконку "MCP Servers" в верхней навигационной панели расширения Caret.
2. Выберите вкладку "Configure", а затем нажмите на ссылку "Advanced MCP Settings" в нижней части этой панели.
3. Caret откроет новое окно настроек. Найдите `Caret>Mcp:Mode` и сделайте свой выбор из выпадающего меню.
...
1. Нажмите на иконку MCP Servers в верхней навигационной панели панели Caret.
...
_Пример конфигурации MCP Server в Caret (STDIO Transport)_
...
После настройки MCP server, Caret автоматически определит доступные инструменты и ресурсы. Чтобы использовать их:

1. Введите свой запрос в окне разговора Caret
2. Caret определит, когда инструмент MCP может помочь с вашей задачей
