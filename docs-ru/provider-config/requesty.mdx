---
title: "Requesty"
description: "Узнайте, как использовать Requesty с Caret для доступа и оптимизации более 150 больших языковых моделей."
---

Caret поддерживает доступ к моделям через AI-платформу [Requesty](https://www.requesty.ai/). Requesty предоставляет простой и оптимизированный API для взаимодействия с более чем 150 большими языковыми моделями (LLM).
...
Requesty предоставляет доступ к широкому спектру моделей. Caret автоматически загрузит актуальный список доступных моделей. Вы можете просмотреть полный список доступных моделей на странице [Model List](https://app.requesty.ai/router/list).
