...
4. Если вы еще этого не сделали, установите VS Code и расширение Careti. Обратитесь к странице [Начало работы](/russian/getting-started/installing-caret) за инструкциями.
