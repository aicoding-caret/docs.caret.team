...
description: "Настройка AWS Bedrock в Careti с использованием учетных данных IAM Access Key и Secret Key. Подходит для корпоративных сред с установленными политиками IAM."
---
