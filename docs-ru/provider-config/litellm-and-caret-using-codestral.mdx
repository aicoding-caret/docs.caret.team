---
title: "LiteLLM и Careti (использование Codestral)"
description: "Узнайте, как настроить и запустить LiteLLM с Careti, используя модель Codestral. Данное руководство охватывает настройку Docker, конфигурацию и интеграцию с Careti."
---
...
-   [Сообщество Careti в Discord](https://discord.gg/WB6yaR89YN)