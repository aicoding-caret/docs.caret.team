...
<Note>
Эти инструменты являются эксклюзивными функциями Caret.
</Note>

Caret предоставляет мощные инструменты, которые позволяют AI напрямую анализировать изображения и документы. Благодаря этим инструментам AI может читать и анализировать файлы просто по их пути, без необходимости пользователям прикреплять их вручную.
...
- **Требуется вход в аккаунт Caret**: Анализ изображений обрабатывается через Caret API.
...
- [Caret Tools Guide](/russian/exploring-carets-tools/caret-tools-guide)
