...
Focus Chain — это функция улучшения управления задачами в Caret, которая обеспечивает автоматическое управление списками задач (todo list) с отслеживанием прогресса в реальном времени на протяжении всего процесса выполнения.
...
Это позволяет Caret работать над долгосрочными задачами, плавно управляя контекстом, передаваемым в LLM, и удерживая Caret на верном пути даже после многочисленных сбросов окна контекста.

:::tip
  Focus Chain особенно эффективно работает с [slash-командой Deep Planning](/russian/features/slash-commands/deep-planning) в Caret, обеспечивая бесшовное отслеживание прогресса для задач реализации, созданных в процессе [планирования](/russian/features/plan-and-act).
:::
...
Caret анализирует вашу задачу и автоматически создает исчерпывающий список дел с:
...
- Бесшовная интеграция обратно в рабочий процесс Caret
...
<Steps>
  <Step title="Откройте настройки Caret">
      - Нажмите на иконку шестеренки в боковой панели Caret
      - Перейдите в раздел «Features»
  </Step>
  <Step title="Включите Focus Chain">
      - Установите галочку «Enable Focus Chain»
      - Опционально настройте «Remind Caret Interval» (по умолчанию: 6 сообщений)
  </Step>
  <Step title="Начните новую задачу">
      - Приступите к новой задаче
      - Caret автоматически начнет создавать и управлять списками задач
  </Step>
</Steps>
...
| Remind Caret Interval | 6 | 1-100 сообщений | Как часто Caret обновляет список задач |
...
Caret создает комплексный план задачи, который хранится в markdown-файле:
...
По мере работы Caret, в заголовке задачи отображается прогресс в реальном времени:
...
<Steps>
  ...
  <Step title="Сохраните файл">
    Caret автоматически обнаружит и применит ваши обновления
  </Step>
</Steps>
...
Focus Chain бесшовно работает с [Plan/Act mode](/russian/features/plan-and-act) в Caret:
...
:::info
  :::details Accordion
    ...
    2. **Проверяйте сгенерированные списки**
      - Убедитесь, что разбивка Caret соответствует вашим ожиданиям
  ...
  :::details Accordion
    ...
    3. **Регулярные проверки**
      ...
      - Сообщайте об изменениях Caret через редактирование файлов
  :::
  :::details Accordion
...
Все еще не получается? Используйте команду [/reportbug](/russian/features/slash-commands/report-bug) в Caret, чтобы получить помощь.
...
Focus Chain превращает Caret в вашего личного менеджера проектов, помогая вам придерживаться плана и организовывать свои задачи. Попробуйте это в своем следующем проекте!